...
const employeeData = {
  employees: [
    { id: 'E001', name: '张伟', gender: '男', dept: '研发部', position: '硬件工程师', phone: '13800001001', email: 'zhangwei@xiaomai.com', entryDate: '2023-03-15', salary: 20000, status: '在职' },
    ...
    { id: 'E005', name: '陈浩', gender: '男', dept: '研发部', position: '软件工程师', phone: '13800001005', email: 'chenhao@xiaomai.com', entryDate: '2022-09-05', salary: 22000, status: '在职' },
    { id: 'E006', name: '刘洋', gender: '男', dept: '供应链部', position: '供应链专员', phone: '13800001006', email: 'liuyang@xiaomai.com', entryDate: '2023-01-18', salary: 13000, status: '在职' },
    ...
    { id: 'E008', name: '周强', gender: '男', dept: '品控部', position: '品质工程师', phone: '13800001008', email: 'zhouqiang@xiaomai.com', entryDate: '2023-08-22', salary: 16000, status: '在职' },
    ...
    { id: 'E010', name: '郑凯', gender: '男', dept: '产品部', position: '产品经理', phone: '13800001010', email: 'zhengkai@xiaomai.com', entryDate: '2021-04-08', salary: 25000, status: '在职' },
  ],
  ...
  recruitment: [
    { id: 'R001', position: '硬件工程师', dept: '研发部', headcount: 3, status: '招聘中', publishDate: '2026-03-01', deadline: '2026-04-01', applicants: 22 },
    { id: 'R002', position: '销售专员', dept: '销售部', headcount: 5, status: '招聘中', publishDate: '2026-03-05', deadline: '2026-04-05', applicants: 35 },
    { id: 'R003', position: '工业设计师', dept: '产品部', headcount: 2, status: '已完成', publishDate: '2026-02-01', deadline: '2026-03-01', applicants: 18 },
    { id: 'R004', position: 'SMT工艺工程师', dept: '生产部', headcount: 2, status: '待发布', publishDate: '2026-03-20', deadline: '2026-04-20', applicants: 0 },
  ],

  performance: [
    { id: 'P001', empId: 'E001', empName: '张伟', dept: '研发部', period: '2026-Q1', score: 92, grade: 'A', comment: '主导完成手机主板改版，性能提升15%' },
    ...
    { id: 'P004', empId: 'E005', empName: '陈浩', dept: '研发部', period: '2026-Q1', score: 94, grade: 'A', comment: '完成手表固件重大版本迭代' },
    { id: 'P005', empId: 'E010', empName: '郑凯', dept: '产品部', period: '2026-Q1', score: 90, grade: 'A', comment: '扫地机器人新品定义清晰，市场反响好' },
  ]
};
