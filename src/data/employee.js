...
const employeeData = {
  employees: [
    ...
    { id: 'E003', name: '王磊', gender: '男', dept: '运营部', position: '运营主管', phone: '13800001003', email: 'wanglei@xiaomai.com', entryDate: '2021-11-20', salary: 16000, status: '在职' },
    ...
    { id: 'E006', name: '刘洋', gender: '男', dept: '市场部', position: '市场专员', phone: '13800001006', email: 'liuyang@xiaomai.com', entryDate: '2023-01-18', salary: 11000, status: '在职' },
    ...
    { id: 'E008', name: '周强', gender: '男', dept: '技术部', position: '测试工程师', phone: '13800001008', email: 'zhouqiang@xiaomai.com', entryDate: '2023-08-22', salary: 15000, status: '在职' },
  ...
  recruitment: [
    ...
    { id: 'R003', position: 'UI设计师', dept: '技术部', headcount: 1, status: '已完成', publishDate: '2026-02-01', deadline: '2026-03-01', applicants: 12 },
    { id: 'R004', position: '数据分析师', dept: '运营部', headcount: 1, status: '待发布', publishDate: '2026-03-20', deadline: '2026-04-20', applicants: 0 },
  ],

  performance: [
    { id: 'P001', empId: 'E001', empName: '张伟', dept: '技术部', period: '2026-Q1', score: 92, grade: 'A', comment: '前端重构按时交付，代码质量高' },
    { id: 'P002', empId: 'E002', empName: '李娜', dept: '销售部', period: '2026-Q1', score: 96, grade: 'A+', comment: '超额完成季度销售目标' },
    { id: 'P003', empId: 'E003', empName: '王磊', dept: '运营部', period: '2026-Q1', score: 85, grade: 'B+', comment: '平台运营指标稳步提升' },
    { id: 'P004', empId: 'E005', empName: '陈浩', dept: '技术部', period: '2026-Q1', score: 90, grade: 'A', comment: '后端架构优化效果显著' },
    { id: 'P005', empId: 'E010', empName: '郑凯', dept: '技术部', period: '2026-Q1', score: 88, grade: 'B+', comment: '产品迭代规划清晰，需求把控好' },
  ]
};
